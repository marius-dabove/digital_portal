...
function Hero({title}) {
    ...
    return(
        <header className='flex h-16 items-center justify-between border-b border-gray-200 dark:border-gray-800 bg-gray-200 dark:bg-gray-900 px-6'>
                    ...
                    <div className='flex items-center gap-6'>
                        ...
                        <div className='flex items-center gap-3'>
                            <div className='h-10 w-10 rounded-full bg-white dark:bg-teal-900 flex items-center justify-center text-teal-700 dark:text-teal-300 font-medium text-lg'>MA</div>
